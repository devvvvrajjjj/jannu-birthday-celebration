    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Isha]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Isha]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>The prettiest girl ever 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Your Bestu Devraj] 💖</h2>
          <p className="final-subtitle">For the one who means more the she know ARIGATOOO ✨</p>
        </section>
      </div>
